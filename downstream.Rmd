...
message("crp_t0")
datatable(crp_t0[,1:6])
message("crp_eos")
datatable(crp_eos[,1:6])
message("crp_pod1")
datatable(crp_pod1[,1:6])
message("avb_t0")
datatable(avb_t0[,1:6])
message("avb_eos")
datatable(avb_eos[,1:6])
message("avb_pod1")
datatable(avb_pod1[,1:6])
...
message("crp_t0_a")
datatable(crp_t0_a[,1:6])
message("crp_t0_b")
datatable(crp_t0_b[,1:6])
message("crp_eos_a")
datatable(crp_eos_a[,1:6])
message("crp_eos_b")
datatable(crp_eos_b[,1:6])
message("crp_pod1_a")
datatable(crp_pod1_a[,1:6])
message("crp_pod1_b")
datatable(crp_pod1_b[,1:6])
message("avb_crplo_t0")
datatable(avb_crplo_t0[,1:6])
message("avb_crphi_t0")
datatable(avb_crphi_t0[,1:6])
message("avb_crplo_eos")
datatable(avb_crplo_eos[,1:6])
message("avb_crphi_eos")
datatable(avb_crphi_eos[,1:6])
message("avb_crplo_pod1")
datatable(avb_crplo_pod1[,1:6])
message("avb_crphi_pod1")
datatable(avb_crphi_pod1[,1:6])
...
message("crp_t0_adj")
datatable(crp_t0_adj[,1:6])
message("crp_eos_adj")
datatable(crp_eos_adj[,1:6])
message("crp_pod1_adj")
datatable(crp_pod1_adj[,1:6])
message("avb_t0_adj")
datatable(avb_t0_adj[,1:6])
message("avb_eos_adj")
datatable(avb_eos_adj[,1:6])
message("avb_pod1_adj")
datatable(avb_pod1_adj[,1:6])
...
datatable(crp_t0_a_adj[,1:6])
message("crp_t0_b_adj")
datatable(crp_t0_b_adj[,1:6])
message("crp_eos_a_adj")
datatable(crp_eos_a_adj[,1:6])
message("crp_eos_b_adj")
datatable(crp_eos_b_adj[,1:6])
message("crp_pod1_a_adj")
datatable(crp_pod1_a_adj[,1:6])
message("crp_pod1_b_adj")
datatable(crp_pod1_b_adj[,1:6])
message("avb_crplo_t0_adj")
datatable(avb_crplo_t0_adj[,1:6])
message("avb_crphi_t0_adj")
datatable(avb_crphi_t0_adj[,1:6])
message("avb_crplo_eos_adj")
datatable(avb_crplo_eos_adj[,1:6])
message("avb_crphi_eos_adj")
datatable(avb_crphi_eos_adj[,1:6])
message("avb_crplo_pod1_adj")
datatable(avb_crplo_pod1_adj[,1:6])
message("avb_crphi_pod1_adj")
datatable(avb_crphi_pod1_adj[,1:6])
