...
1. CRP group comparisons not stratified for treatment group (inflamation) Need to do

2. Treatment group comparisons not stratified for CRP group (Steroid) (Done)

3 Treatment group complarisons stratified for CRP group:  steroid and inflammation (Done)
