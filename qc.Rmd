...
I think your questions relate to aim 1.

1.     Characterise the relationship between the early (within 24h) systemic inflammatory-immune gene expression
response and postoperative systemic inflammation and the effect of intraoperative dexamethasone

Specific hypothesis: Patients with high levels of postoperative systemic inflammation, as measured by CRP,
demonstrate greater early (within 24 h) changes in immune cell gene expression compared to patients with low levels
of postoperative systemic inflammation following major surgery.

1. Stratify for CRP group at each time point (Q4 Hi vs Q1 low). Should be ballanced analysis at each time point
hightlight the effect of inflammation.
...
2. Statify for Treatment group (A or B partially blinded).
This should be ballanced as Treatment A or B (as per randomisaiton) at each time point.
Highligh the effect or treatment.

3. Within Q4 stratify for A or B (un ballanced) set up for aim 2

4. Within Q1 stratify for A or B (un ballanced) set up for aim 2

This will address the hypothesis 1, and set up for the analysis to follow (aim 2).

The analysis will be A. un-adjusted and B. adjsuted for confounding variables as per the planned to include from
the PCAs.
All analysis are adjusted for the cell characterisations.
Not sure about neutrophils, as there shouldnt be any in PBMCs?

Note the 4 groups.

High inflammation (Q4) with treatment A

* High inflammation (Q4) with treatment B

* Low inflammation (Q1) with treatment A

* Low inflammation (Q1) with treatment B

Next phase will be:

2.     Identify the top early (withing 24h) differentially expressed inflammatory-immune genes associated with
postoperative systemic inflammation and the effect of intraoperative dexamethasone.

Specific hypothesis: The early (within 24 h) changes in immune cell gene expression associated with postoperative
systemic inflammation are significantly altered by intra-operative dexamethasone (8 mg) compared to placebo.


## Treatment group differences not stratified for CRP group

### Treatment group differences in t0
...
# Monocytes.C NK T.CD8.Memory T.CD4.Naive Neutrophils.LD
dds <- DESeqDataSetFromMatrix(countData = mx , colData = ss2,
  design = ~ sexD + wound_typeOP + duration_sx + ethnicityCAT + ageCS + Monocytes.C + NK + T.CD8.Memory + T.CD4.Naive + Neutrophils.LD + treatment_group )
...
### Treatment group differences in EOS
...
### Treatment group differences in POD1
